...
models <- list(
  "Like existing system" = lm(stateInterv_continueIncreaseGESPrice ~
      ...
      data = data),
  "Redistribute pop" = lm(stateInterv_continueIncreaseGESPrice_RedistributedPop ~
        scale_gravity + region + ses_gender_male +
        ses_age_24m + ses_age_2534 + ses_age_5564 +
        ses_age_6574 + ses_age_75p + ses_bornCanada +
        ses_educUniv + ses_incomeLow + ses_incomeMid,
      data = data),
   "Fossil jobs" = lm(stateInterv_continueIncreaseGESPrice_FossilJobs ~
         scale_gravity + region + ses_gender_male +
         ses_age_24m + ses_age_2534 + ses_age_5564 +
         ses_age_6574 + ses_age_75p + ses_bornCanada +
         ses_educUniv + ses_incomeLow + ses_incomeMid,
       data = data),
  "Green jobs" = lm(stateInterv_continueIncreaseGESPrice_GreenJobs ~
         scale_gravity + region + ses_gender_male +
         ses_age_24m + ses_age_2534 + ses_age_5564 +
         ses_age_6574 + ses_age_75p + ses_bornCanada +
         ses_educUniv + ses_incomeLow + ses_incomeMid,
